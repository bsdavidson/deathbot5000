...
Physics.prototype.intersectSegmentIntoBox = function(
    segmentPos, segmentDelta, paddedBox, debug) {
...
Physics.prototype.sweepBoxIntoBox = function(
    movingBox, segmentDelta, staticBox) {
  var segmentPos = {
...
Physics.prototype.intersectSegmentIntoBoxes = function(
    segmentPos, segmentDelta, staticBoxes) {
...
Physics.prototype.sweepBoxIntoBoxes = function(
    movingBox, segmentDelta, staticBoxes) {
  var nearestResult = null;
  for (var i = 0, il = staticBoxes.length; i < il; i++) {
    var staticBox = staticBoxes[i];
...
Physics.prototype.checkNearestHit = function(
    sourceActor, staticResult, targetResult) {
  var result = {};
